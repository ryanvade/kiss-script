...
public:
    ...
    void setupUi(QWidget *Repository)
    {
        ...
        Repository->resize(1039, 623);
        verticalLayout_4 = new QVBoxLayout(Repository);
        verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
        splitter = new QSplitter(Repository);
        splitter->setObjectName(QString::fromUtf8("splitter"));
        splitter->setOrientation(Qt::Horizontal);
        ui_availGroup = new QGroupBox(splitter);
        ui_availGroup->setObjectName(QString::fromUtf8("ui_availGroup"));
        verticalLayout = new QVBoxLayout(ui_availGroup);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        ui_list = new QListWidget(ui_availGroup);
        ...
        ui_source = new QPushButton(ui_availGroup);
        ...
        ui_mark = new QPushButton(ui_availGroup);
        ...
        splitter->addWidget(ui_availGroup);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/shortcuts/target/icon_set/icons/cog_go.png"), QSize(), QIcon::Normal, QIcon::Off);
        ui_begin->setIcon(icon2);
    ...
    void retranslateUi(QWidget *Repository)
    {
        ...
        ui_availGroup->setTitle(QApplication::translate("Repository", "Available", 0, QApplication::UnicodeUTF8));
