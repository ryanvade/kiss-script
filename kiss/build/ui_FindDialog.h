...
public:
    ...
    void setupUi(QDialog *FindDialog)
    {
        ...
        hboxLayout3->addWidget(ui_buttonReplace);
        ...
        hboxLayout3->addWidget(ui_buttonReplace_All);

        ui_buttonFind = new QPushButton(FindDialog);
        ui_buttonFind->setObjectName(QString::fromUtf8("ui_buttonFind"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/shortcuts/edit/icon_set/icons/find.png"), QSize(), QIcon::Normal, QIcon::Off);
        ui_buttonFind->setIcon(icon1);

        hboxLayout3->addWidget(ui_buttonFind);
