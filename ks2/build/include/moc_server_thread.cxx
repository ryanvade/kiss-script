/****************************************************************************
** Meta object code from reading C++ file 'server_thread.hpp'
**
...
#include "../../include/server_thread.hpp"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'server_thread.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_ServerThread[] = {
    "ServerThread\0\0state\0stateChanged(QString)\0"
    "executable\0run(QString)\0"
};
...
void ServerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->run((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void ServerThread::stateChanged(const QString & _t1)
{
...
// SIGNAL 1
void ServerThread::run(const QString & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
