/****************************************************************************
** Meta object code from reading C++ file 'console_widget.hpp'
**
...
#include "../../include/console_widget.hpp"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'console_widget.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_ConsoleWidget[] = {
    "ConsoleWidget\0\0readStandardOut()\0"
};
...
void ConsoleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->readStandardOut(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
